...
<body class="clinic_version">
         ...
         <div class="row">
            <div class="col-md-12 col-sm-12">
               <div class="text-contant">
                  <h2>
                     <span class="center"><span class="icon"><img src="images/gracepath-icon.png" alt="#" /></span></span>
                     <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome to Grace Path Diagnostic Centre", "We Care Your Health", "We are Expert!" ]'>
         ...
         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="row">
               <div class="service-time one" style="background:#2895f1;">
                  ...
                  <p>Our diagnostics centre has assembled a team of well qualified, dynamic and experienced professional
                     with varying background.</p>
               </div>
            </div>
         </div>
         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="row">
               <div class="service-time middle" style="background:#0071d1;">
                  ...
                  <div class="time-table-section">
                     <ul>
                        <li><span class="left">Monday - Friday</span><span class="right">24/7 hrs</span></li>
                        <li><span class="left">Saturday</span><span class="right">8:30 am – 4:00 pm</span></li>
                        <li><span class="left">Sunday</span><span class="right">12:00 am – 5:00 pm</span></li>
                     </ul>
                  </div>
               </div>
            </div>
         ...
         <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="row">
               <div class="service-time three" style="background:#0060b1;">
                  ...
                  <p>Our state of the art equipment guarantees the best in modern day practice of diagnostics</p>
               </div>
            </div>
         </div>
      </div>
   ...
   <div id="about" class="section wow fadeIn">
      <div class="container">
         <div class="heading">
            <span class="icon-logo"><img src="images/gracepath-icon.png" alt="#"></span>
         ...
         <div class="row">
            <div class="col-md-6">
               <div class="message-box">
                  ...
                  <p class="lead">Grace Path Diagnostic Centre (GPDC) is a first-class medical diagnostic centre located
                     in a spacious purpose built 3 Story building on 66, Igi Olugbin road, Pedro Road Ladi-Lak Bariga,
                     Lagos. </p>
                  <p> We provide accurate, reliable and timely medical results in the following areas: Clinical
                     pathology, Hematology, Ultrasound, CT Scan, X-ray services, Microbiology, Bio chemistry,
                     Consultancy and advisory services, Medical support services.
                  </p>
            ...
            <div class="col-md-6">
               <div class="post-media wow fadeIn">
                  ...
                  <a href="https://www.youtube.com/watch?v=OLIRjW_1eOQ" data-rel="prettyPhoto[gal]" class="playbutton"><i class="flaticon-play-button"></i></a>
               </div>
               <!-- end media -->
            </div>
            <!-- end col -->
         ...
         <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
               <div class="service-widget">
                  ...
                  <h3 style="font-size: 90%;">A spacious purpose 3-Story building</h3>
               </div>
               <!-- end service -->
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
               <div class="service-widget">
                  ...
                  <h3>Detailed Medical Check-up</h3>
               </div>
               <!-- end service -->
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
               ...
               <div class="inner-services">
                  <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                     <div class="serv">
                        ...
                        <p>We've provide in up to date and modern equipment, that will aid us
                           in operating seamlessly. </p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                     <div class="serv">
                        ...
                        <p>We are located in a spacious purpose built three-floor structure modern designed. Total floor
                           area is 399.40 sq. meters.</p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                     <div class="serv">
                        ...
                        <p>Members of our team are carefully selected personnel based on high level of integrity,
                           competence and professionalism. </p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                     <div class="serv">
                        ...
                        <p>Consistently we provide accurate, reliable and timely delivery of medical results.</p>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                     <div class="serv">
                        ...
                        <fieldset>
                              ...
                              <div class="row">
                                 <div class="form-group">
                                    <select class="form-control">
                                       ...
                                       <option>Dr. Popoola</option>
                                       <option>Dr. Akinsegun</option>
                                       <option>Dr. Soyemi</option>
                                       <option>Dr. Ayodele</option>
                                    </select>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="row">
                                 <div class="form-group">
                                    <div class="center">
                                       <a href="appointment.html"><button type="button">Book appointment</button></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
   ...
   <div id="doctors" class="parallax section db" data-stellar-background-ratio="0.4" style="background:#fff;" data-scroll-id="doctors" tabindex="-1">
      <div class="container">
         ...
         <div class="heading">
            <span class="icon-logo"><img src="images/gracepath-icon.png" alt="#"></span>
            <h2>Experienced Doctor Team</h2>
         </div>

         <div class="row dev-list text-center">
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
               <div class="widget clearfix">
                  <img src="images/doctor_01.jpg" alt="" class="img-responsive img-rounded">
                  <div class="widget-title">
                     <h3>Prof. A. Popoola</h3>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn;">
               <div class="widget clearfix">
                  <img src="images/doctor_02.jpg" alt="" class="img-responsive img-rounded">
                  <div class="widget-title">
                     <h3>Prof. A. Akinsegun</h3>
                     <small>Hematologist</small>
                  </div>
                  <!-- end title -->
                  <!-- <p>Hello guys, I am Soren from Sirbistana. I am senior art director and founder of Violetta.</p> -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 wow fadeIn">
               <div class="widget clearfix">
   ...
   <div id="price" class="section pr wow fadeIn" style="background-image:url('images/price-bg.png'); margin-top: 100px; padding: 30px; overflow: visible;">
      <div class="container">
         <div class="row">

            <div class="col-lg-5 col-md-5">
               <h2 style="color: white;"><b>Online Hassle Free Appointment Booking</b></h2>
               <h1 style="color: white;"><i class="fa fa-phone-square"></i> +2484-398-8987</h1>
            </div>
            <div class="col-lg-4 col-md-4">
               <a href="">
                  <!-- Book Appointment page link goes here {For Jude}-->
                  <button type="button" class="btn btn-default btn-lg text-uppercase" style="-webkit-box-shadow: 4px 4px rgb(85 85 85 / 20%); -moz-box-shadow: 4px 4px rgba(85, 85, 85, 0.2); box-shadow: 4px 4px rgb(85 85 85 / 20%);">Book
                     your Appointment</button>
               </a>
            </div>
            <div class="col-lg-3 col-md-3 hidden-sm hidden-xs">
               <div style="bottom: -105px; position: absolute;">
                  <img src="images/appointment-booking-img.png">
               </div>
            </div>
         </div>
      </div>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group in_name">
                        <input type="text" class="form-control" id="contact_name" placeholder="Name" required="required">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group in_email">
                        <input type="email" class="form-control" id="contact_email" placeholder="E-mail" required="required">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group in_email">
                        <input type="tel" class="form-control" id="contact_phone" placeholder="Phone" required="required">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group in_email">
                        <input type="text" class="form-control" id="contact_subject" placeholder="Subject" required="required">
                     </div>
                  </div>
                  <div class="col-md-12">
                     <div class="form-group in_message">
                        <textarea class="form-control" id="contact_comments" rows="5" placeholder="Message" required="required"></textarea>
                     </div>
                     <div class="actions">
                        <input type="submit" value="Send Message" name="submit" id="submit" class="btn small" title="Submit Your Message!">
                     </div>
                  </div>
               </div>
            </form>
            ...
            <div class="col-md-4">
               <div class="logo padding">
                  ...
                  <p>GPDC is a first-class medical diagnostic centre which provides wide
                     scope for detection of ailments and facilities for a detailed medical check-up through diagnostic
